...
function toTS(obj, name) {
    ...
    str = str.replace(/"([^"]+)":/g, '$1:');
    // Keep double quotes around values to prevent syntax errors with apostrophes
...
console.log('Successfully applied ALL contexts robustly without breaking syntax!');
