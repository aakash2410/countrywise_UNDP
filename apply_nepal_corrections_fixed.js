...
let limitIdx = mockData.indexOf(endMarker, startIdx); // Safe limit
...
console.log("Applying detailed patches to Nepal chunk...");
...
console.log('Successfully applied Nepal corrections (Fixed index).');
