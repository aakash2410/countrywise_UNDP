...
"[project]/src/components/dashboard/MockData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const radarData = [
    ...
    {
        parameter: 'Digital Infra Availability',
        Malaysia: 5,
        Cambodia: 2,
        Philippines: 2,
        Bangladesh: 2,
    ...
    {
        parameter: 'Stakeholder Participation',
        Malaysia: 3,
        Cambodia: 3,
        Philippines: 3,
        Bangladesh: 3,
...
const malaysiaData = {
    ...
    dpiEcosystem: {
        digitalId: {
            title: 'Digital ID',
            status: 'Maturing',
            description: 'MyDigital ID (8.7M users)',
            implementationAgency: 'My Digital ID Sdn Bhd',
            modalDetails: {
        ...
        payments: {
            ...
            status: 'Maturing',
            description: 'DuitNow (5.3 bn transactions)',
            implementationAgency: 'PayNet',
            modalDetails: {
        ...
        dataExchange: {
            title: 'Data Exchange',
            status: 'Maturing',
            description: 'MYGDX (35 million transactions)',
            implementationAgency: 'MAMPU',
            modalDetails: {
        ...
        useCases: [
            {
                ...
                description: 'Single sign-on via MyGovernment portal (managed by JDN) — goal: 95% federal services integrated with MyDigital ID by 2030'
            },
            {
                sector: 'Telecommunications',
                description: 'SIM card registration linked to MyDigital ID for identity verification'
            },
            {
                sector: 'Social Protection',
                description: 'Sumbangan Tunai Rahmah (STR) — G2P cash transfer program channelled via digital payment rails'
            }
        ]
    },
    aiEcosystem: {
        policy: {
            title: 'AI Strategy',
            status: 'Maturing',
            description: 'Malaysia Artificial Intelligence Roadmap 2021-2025',
            implementationAgency: 'Malaysian National AI Office (NAIO)',
            modalDetails: {
        ...
        governance: {
            ...
            description: 'National Guidelines on AI Governance and Ethics (AIGE)',
            implementationAgency: 'Malaysian National AI Office (NAIO)',
            modalDetails: {
        ...
        legislation: {
            ...
            status: 'Maturing',
            description: 'Data Protection and Privacy Laws',
            implementationAgency: 'Department of Personal Data Protection',
            modalDetails: {
        ...
        initiatives: {
            ...
            status: 'Maturing',
            description: 'AI in Healthcare & Digital Hospitals',
            implementationAgency: 'Ministry of Health',
            modalDetails: {
    ...
    sectionB: {
        ...
        politicalSubParameters: [
            {
                label: 'Elections',
                value: '5-year cycle (last: Nov 2022). Historical instability since 2020 led to changes in coalition governments.'
            },
            {
                label: 'Governance Structure',
                value: 'Federal Parliamentary Democracy under a Constitutional Monarchy with distinct Executive, Judicial, and Legislative branches.'
            },
            {
                label: 'Political Stability',
                value: 'Stable but fragile. Ranked 44/167 (Flawed Democracy). Metrics: Accountability (54.6), Stability (72.4), Rule of Law (62.9).'
            },
            {
                label: 'Institutional Capacity',
                value: 'Strong focus on digital upskilling via MyDIGITAL, Public Sector AI Guidelines, and private partnerships (e.g., Microsoft). Lacks a uniform training mandate.'
            },
            {
                label: 'Leadership Champions',
                value: 'Prime Minister Anwar Ibrahim and Minister of Digital Gobind Singh Deo are vocal advocates for inclusive, AI-driven transformation.'
            },
            {
                label: 'Key Influencers',
                value: 'MOSTI AI Governance Structures, National Digital Economy Council (MED4IRN), and the Prime Minister\'s Office.'
            }
        ],
        leadershipQuote: {
        ...
        actors: [
            {
                ...
                name: 'Ministry of Digital, MOSTI, MAMPU, NAIO',
                role: 'Decision-makers & Implementers',
                initiatives: [
                    'National AI Roadmap 2021-2025',
                    'National Guidelines on AI Governance and Ethics',
                    'RM285M MOSTI + RM10M NAIO budget allocation',
            ...
            },
            {
                id: 'm2',
                type: 'Private Sector',
                name: 'Toshiba, Microsoft, Google, AWS, YTL Power, ByteDance, Oracle',
                role: 'Implementers & Co-Investors',
                initiatives: [
                    'Microsoft: USD 2.2B for cloud and AI services',
                    'Google: USD 2B for first data centre region',
                    'YTL Power: Developing Ilmu 0.1, a Malaysian LLM',
                    '284 AI companies, targeting 900 by 2026'
                ]
            },
            {
                id: 'm3',
                type: 'Development Partners & MDBs',
                name: 'MYCentre4IR (WEF), UNESCO, UNDP',
                role: 'Advisory & Strategy Support',
                initiatives: [
                    'MYCentre4IR connects NAIO with global WEF experts',
                    'AI Readiness Assessment Methodology (RAM)',
                    'Co-developing thought leadership publications'
                ]
            },
            {
                id: 'm4',
                type: 'Academic & Research',
                name: 'UTM (CAIRO), UM (MALAYA AIR), UMS (AiRU), Nottingham Malaysia',
                role: 'R&D & Talent Pipeline',
                initiatives: [
                    'Centre for AI and Robotics (CAIRO) at UTM',
                    'RM50M AI education budget across research universities',
                    'AI Sandbox 2024 Pilot',
                    'Curriculum development and talent pipelines'
                ]
            },
            {
                id: 'm5',
                type: 'Civil Society',
                name: 'PIKOM, MIFA, Women in AI',
                role: 'Advocacy & Inclusion',
                initiatives: [
                    'Promoting AI literacy and digital inclusion',
                    'Gender equity in AI adoption',
                    'Quadruple Helix Model engagement'
                ]
            }
        ]
    },
    sectionD: {
        opportunities: [
            {
                id: 'co1',
                text: 'UNDP can provide technical support on regulatory design for AI Governance and Regulatory Frameworks, drawing on examples from other countries such as Singapore'
            },
            {
                id: 'co2',
                text: 'Malaysia is one of the most AI-mature countries in the Digital Stewardship Community. UNDP can position it as a knowledge contributor - the country can share its experience in developing an AI strategy, establishing a dedicated AI agency, implementing use cases, and building AI infrastructure etc. with earlier-stage countries in the region.'
            },
            {
                id: 'co3',
                text: 'The government wants to grow its AI startup base from 284 to 900 companies by 2026. UNDP can support in an innovation accelerator program to provide grants and mentorship for startups focusing on AI for Good the startups. They can also support in creating an AI Sandbox initiative.'
            }
        ],
        risks: [
            {
                id: 'cr1',
                text: 'AI adoption is accelerating across healthcare, finance, and agriculture, yet Malaysia’s AI ethics guidelines remain voluntary and non-binding. Without enforceable standards, biased or opaque algorithms in public services could erode citizen trust, creating a risk of AI adoption without accountability.'
            },
            {
                id: 'cr2',
                text: 'Malaysia has invested heavily in individual DPI components, but integration between foundational DPI assets remains limited. Without deliberate interoperability design and careful sequencing of use cases, Malaysia risks not achieving its 2030 target of integrating 95% of services. As a result, despite significant public investment in infrastructure, citizen-facing outcomes may remain limited'
            }
        ],
        partnerships: [
            {
                id: 'cp1',
                text: 'Partnership with National AI Office (NAIO) - NAIO was established in 2024 and is still building operational capacity. UNDP can establish an advisory relationship with NAIO. UNDP can suuport the transition of voluntary AI ethics guidelines into an enforceable regulatory framework and can provide support in the capacity building of officials.'
            },
            {
                id: 'cp2',
                text: 'Partnership with Malaysia Digital Economic Corporation (MEDC) and MyDIGITAL Corporation - UNDP can engage with these agencies to co-design a DPI interoperability roadmap and prioritise citizen-centric use cases and support the achievement of the 2030 target of integrating 95% of services with Digital ID.'
            },
            {
                id: 'cp3',
                text: 'Partnership with NAIO and Microsoft - Microsoft, NAIO, and PETRONAS Leadership Centre are jointly establishing an AI Center focused on developing real-world AI solutions and nurturing talent. UNDP can engage this initiative to co-design an AI for Good accelerator track that directs mentorship, grants, and sandbox access toward startups working on development challenges in areas like healthcare, agriculture, and social protection. With the government targeting growth from 284 to 900 AI companies by 2026, UNDP can play a focused role in ensuring a share of this startup growth is channelled toward public interest outcomes.'
            }
        ]
    },
    parameterStages: {
        P1: {
            ...
            subParameters: [
                ...
                {
                    name: 'AI Governance & Ethical AI Principles',
                    stage: 'Early Success'
                },
                {
                    name: 'Data Protection & Privacy Legislation',
                    stage: 'Maturing'
                },
                {
                    name: 'Government AI Initiatives & Projects',
                    stage: 'Maturing'
                }
            ]
        },
        ...
        P3: {
            ...
            parameterStage: 'Role Model',
            subParameters: [
                {
                    name: 'Electricity Access & Reliability',
                    stage: 'Role Model'
                },
                {
        ...
        P4: {
            parameter: 'Political Stability & Governance',
            parameterStage: 'Maturing',
            subParameters: [
                {
                    name: 'WB Political Stability Score (2024)',
                    stage: 'Maturing'
                }
            ]
        },
        P5: {
            ...
            subParameters: [
                {
                    name: 'Lead Agency & Govt Coordination',
                    stage: 'Maturing'
                },
                {
                ...
                {
                    name: 'Development Partners & MDBs',
                    stage: 'Open to Adopt'
                },
                {
    ...
    sources: [
        ...
        "https://www.unesco.org/ethics-ai/en/malaysia",
        "https://digitaldevelopmentcompass.undp.org/country/MYS",
        "https://www.mygov.gov.my/ms-MY",
        "https://www.digital-id.my/_next/about",
        "https://www.mosti.gov.my/wp-content/uploads/2023/12/PR-231212-MYDIGITAL-ID-REGISTRATION-FOR-THE-GENERAL-PUBLIC-WILL-COMMENCE-IN-MARCH-2024.pdf",
        "https://www.thestar.com.my/news/nation/2026/02/24/weaknesses-in-management-and-expenditure-of-mydid-project-revealed",
        "https://fastpayments.worldbank.org/sites/default/files/2021",
        "https://www.malaysia.gov.my/en",
        "https://www.biometricupdate.com/202510/malaysia-targets-15m-mydigital-id-users-2026-funds-allocated",
        "https://malaysia.news.yahoo.com/only-2-8-million-malaysians-044521446.html",
        "https://www.malaymail.com/news/malaysia/2026/01/17/mydigital-id-hits-87-million-users-sets-sights-on-15-million-sign-ups-with-e-hailing-boost/205833",
        "https://fastpayments.worldbank.org/sites/default/files/2021-09/World_Bank_FPS_Malaysia_RPP_Case_Study.pdf",
        "https://paynet.my/",
        "https://en.wikipedia.org/wiki/Elections_in_Malaysia",
        "https://en.wikipedia.org/wiki/2022_Malaysian_general_election",
        "https://www.electiondata.my/elections",
        "https://www.malaysia.gov.my/en/government/sistem-pemerintahan-negara/federal-government",
        "https://www.eiu.com/n/campaigns/democracy-index-2024-confirmation/",
        "https://www.worldbank.org/en/publication/worldwide-governance-indicators/interactive-data-access",
        "https://www.ai.gov.my/",
        "https://www.ai.gov.my/thought-leadership"
    ]
};
const cambodiaData = {
    ...
    dpiEcosystem: {
        digitalId: {
            title: 'Digital ID',
            status: 'Early Success',
            description: 'CamDigiKey (86k Users)',
            implementationAgency: 'MEF',
            modalDetails: {
        ...
        payments: {
            title: 'Digital Payments',
            status: 'Maturing',
            description: 'Bakong (60% adult population)',
            implementationAgency: 'NBC',
            modalDetails: {
                ...
                keyMetrics: [
                    "Reaches 60% of the adult population",
                    "Operates across local banks and e-wallets",
        ...
        dataExchange: {
            ...
            status: 'Maturing',
            description: 'CamDX',
            implementationAgency: 'Techo Startup Center',
            modalDetails: {
                ...
                keyMetrics: [
                    "Managed by MEF",
                    "Powers Verify.gov.kh",
                    "Core to Cambodian e-gov architecture",
        ...
        useCases: [
            {
                ...
                description: 'CamDigiKey used for e-KYC authentication across banks and financial institutions'
            },
            {
                sector: 'E-Government',
                description: 'CamDigiKey integrated into e-Government services for citizen identity verification'
            },
            {
                sector: 'Business Registration',
                description: 'Major adoption in business registration workflows via digital identity and data exchange layers'
            },
            {
                sector: 'Document Verification',
                description: 'Verify.gov.kh — blockchain-powered platform for secure government document verification'
            }
        ]
    },
    aiEcosystem: {
        policy: {
            ...
            description: 'National AI Strategy 2025-30',
            implementationAgency: 'Ministry of Post and Telecommunications',
            modalDetails: {
        ...
        governance: {
            ...
            implementationAgency: 'Ministry of Post and Telecommunications (MPTC)',
            modalDetails: {
        ...
        initiatives: {
            title: 'Government AI Initiatives',
            status: 'Early Success',
            description: 'National Research Center on AI & Landmine mapping',
            implementationAgency: 'CMAC & MPTC',
            modalDetails: {
    ...
    sectionB: {
        ...
        politicalSubParameters: [
            {
                label: 'Elections',
                value: '5-year cycle (last: 2023-24; next: 2028-29). Predominantly one-party governance model — could track key people of interest and their ministerial terms.'
            },
            {
                label: 'Governance Structure',
                value: 'Constitutional Monarchy with a Parliamentary system, governed centrally by mostly one-party rule.'
            },
            {
                label: 'Political Stability',
                value: 'WB Political Stability at 68th percentile (Maturing). Democracy Index 2024: Authoritarian (123/169). Cambodia-Thailand border tensions could escalate, potentially shifting priorities from DT toward national security.'
            },
            {
                label: 'Digital Priority',
                value: 'Strong and growing. Pentagonal Strategy Phase I places human development and digital transformation as core pillars. National AI Strategy drafted, National Research Center on AI for Education inaugurated Nov 2025.'
            },
            {
                label: 'Institutional Capacity',
                value: 'DataBank Performance Indicators show increasing capacity (2019-2023), especially in institutional data collection. Digital transformation policies are gaining institutional depth.'
            },
            {
                label: 'Leadership Champions',
                value: 'PM Hun Manet (Digital Revolution emphasis); H.E. Chea Vandeth (Minister of PTC, Head of Digital Governance Committee, ethics-technology balance); H.E. Sam Sethserey (DG of ICT at MPTC, cybersecurity & startup ecosystem); Seng Molika (DDG of STI at MISTI, DT unit lead).'
            },
            {
                label: 'Key Influencers',
                value: 'MPTC (backbone and governance), MISTI (R&D and adoption), Working Group on AI and Data Science R&D (drafted the National AI Strategy).'
            }
        ],
        leadershipQuote: {
        ...
        actors: [
            {
                ...
                type: 'Lead Agency & Govt Coordination',
                name: 'MPTC, MISTI, MEF',
                role: 'Decision-maker & Lead',
                initiatives: [
                    'National AI Strategy 2025-30 (drafted by MPTC)',
                    'Digital Economy and Society Policy Framework 2021-2035',
                    'No single agency for overall DT — fragmented across ministries'
                ]
            },
            {
                id: 'c2',
                type: 'Private Sector',
                name: 'Techo Startup Center, First Cambodia, Smart Axiata, Alibaba Cloud',
                role: 'Implementer & Incubator',
                initiatives: [
                    'Techo Startup Center: govt-supported private incubator/accelerator',
                    'Smart Axiata works with MPTC on connectivity',
                    'Alibaba Cloud increasing presence in Cambodia'
                ]
            },
            {
                id: 'c3',
                type: 'Development Partners & MDBs',
                name: 'UNESCO, ADB, UN ESCAP, AI Singapore',
                role: 'Technical Expertise & Funding',
                initiatives: [
                    '~$3.1B in ADB concessional loans/SDRs',
                    'UNESCO "AI Ethics Experts Without Borders"',
                    'MoU with AI Singapore for open-source Khmer LLM'
                ]
            },
            {
                id: 'c4',
                ...
                role: 'Research & Capacity Building',
                initiatives: [
                    'Co-drafted the National AI Strategy',
                    'National Research Center on AI for Education (inaugurated Nov 2025)',
                    'Part of country\'s capacity building efforts'
                ]
            },
            {
                id: 'c5',
                type: 'Civil Society',
                name: 'Development Innovations Project, Civil Society Consultations',
                role: 'Advocacy & Digital Literacy',
                initiatives: [
                    'Cambodian Development Innovations Project (since 2013)',
                    'Civil societies actively consulted during NAS formulation',
                    'Internet penetration rose from 6.8% to 56.7% (2013-2024)'
                ]
            }
        ]
    },
    sectionD: {
        opportunities: [
            {
                id: 'kh-o1',
                text: 'KhmerLLM for eGov: Operationalising and integrating KhmerLLM to make eGov services more accessible for the ~95% of citizens using the Khmer language.'
            },
            {
                id: 'kh-o2',
                text: 'Cyber-Resilience & Guidelines: Partnering with MPTC to prevent misinformation and deepfakes by operationalising specific guidelines and defensive tools.'
            },
            {
                id: 'kh-o3',
                text: 'Democratising AI: Addressing gender, language, and urban/rural divides through programs that democratise AI access and technical capacity.'
            }
        ],
        risks: [
            {
                id: 'kh-r1',
                text: 'Institutional Fragmentation: Digital initiatives are currently split across MPTC, MISTI, and MEF, leading to coordination challenges.'
            },
            {
                id: 'kh-r2',
                text: 'Political Prioritisation: Possible de-prioritisation of Digital Transformation if current regional or domestic conflicts escalate.'
            },
            {
                id: 'kh-r3',
                text: 'Data Scarcity: Extremely limited digital text and audio data available for training the Khmer-based LLM despite widespread language use.'
            }
        ],
        partnerships: [
            {
                id: 'kh-p1',
                text: 'CADT Collaboration: Partnering with the Cambodia Academy of Digital Technology for inclusive capacity building and equitable representation in research.'
            },
            {
                id: 'kh-p2',
                text: 'Cloud Compute Expansion: Working with technical institutions to increase GPU and cloud access, which currently sits at only 11%.'
            },
            {
                id: 'kh-p3',
                text: 'CamDigiKey Adoption: Partnering with the Ministry of Economics and Finance (MEF) to increase adoption of CamDigiKey and assess barriers via KIIs.'
            }
        ]
    },
    parameterStages: {
        ...
        P2: {
            ...
            subParameters: [
                ...
                {
                    name: 'Availability / Deployment Use Cases',
                    stage: 'Early Success'
                }
            ]
        },
    ...
    sources: [
        ...
        "https://data.opendevelopmentcambodia.net/en/dataset/5524b0b4-bb31-4cad-abf4-a36f8e82073d/resource/a35e29b9-3dbf-4a5d-92a9-4d3558ed3c03/download/nais-v5-en-for-consultation-clean.pdf",
        "https://www.unesco.org/ethics-ai/en/global-hub",
        "https://www.unesco.org/ethics-ai/en/cambodia",
        "https://www.dlapiperdataprotection.com/",
        "https://www.dlapiperdataprotection.com/?t=law&amp;c=KH#insight",
        "https://www.nec.com/en/press/202510/global_20251029_04.html",
        "https://www.worldbank.org/en/programs/govtech/gtmi-2025-update",
        "https://datahub.itu.int/dashboards/idi/?e=BGD&amp;y=2025",
        "https://dpimap.org/",
        "https://camdigikey.gov.kh/en",
        "https://bakong.nbc.gov.kh/en/",
        "https://camdx.gov.kh/",
        "https://dpiexplorer.org/explore",
        "http://verify.gov/",
        "https://verify.gov.kh/",
        "https://kiripost.com/stories/nbcs-bakong-charts-transaction-growth-at-13b-in-2025",
        "https://www.khmertimeskh.com/501517074/camdx-sees-13-increase-in-usage-to-17-3m-transactions/",
        "https://www.itu.int/reports/wsis-gdc-implementation/objectives/gdc-objective-4/data-for-sustainable-development-goals/",
        "https://kiripost.com/stories/cambodias-untold-digital-divide-why-not-all-daughters-get-to-imagine-a-different-future",
        "https://www.eiu.com/n/global-themes/democracy-index/",
        "https://cambodianess.com/article/hun-manet-says-teachers-catalysts-of-cambodias-ai-transformation",
        "https://databank.worldbank.org/reports.aspx?dsid=31&amp;series=IQ.CPA.MACR.XQ",
        "https://docs.google.com/spreadsheets/d/1vNBjyTfs7Ysur_2Zwu3cPb26NQurQAkcQp_InWwLI0Y/edit?gid=0#gid=0",
        "https://theinvestor.vn/cambodia-focuses-on-digital-revolution-d9023.html#:~:text=By%20Vietnam%20News%20Agency,growth%20and%20improve%20social%20welfare.",
        "https://www.mordorintelligence.com/industry-reports/cambodia-ict-market/companies",
        "https://firstcambodia.com.kh/",
        "https://www.alibabacloud.com/en/campaign/cambodia-contact-us?_p_lc=1#:~:text=Secure%2C%20convenient%2C%20and%20private%20connections,private%20domain%20name%20management%20service",
        "https://www.zoominfo.com/top-lists/top-telecommunications-companies-in-KH",
        "https://cambodia.un.org/en/about/un-entities-in-country?afd_azwaf_tok=eyJraWQiOiJGQ0U3Q0M5QjEyMjMyMDkzMkU2RUI5N0I5MTM5NTkzREU2NUZDNjlBRDFDQUVGMkY5REFFOUY1MEJFMEVCNTcwIiwiYWxnIjoiUlMyNTYifQ..OqXDB32T7SrmR4kTCQbxCyMv9pCZlP0-6ZYEXcNwGB81XIVwBbXtrjRIR-JTl37MqqIIpc4Gxgl0YIQipsQHhNtHptVlhh-4VRIVD_f_T2MHiWtyPe85PTaMaInH7gJaGFmbzweBHAnQpnGlurLJNUfgyfhTdWNr1jL06G8l8vqontZStkLernOSryiXXjBDUOIker2pdsaE8SPepBN_KWaxjKk6vRxXYAZs8t9x6ZXbYppgI2OGwdcqo2hajUveiY--VIvb2sczO1TqdFzaKbhXjOS4NIG595iFIQ3fl_OUfPco3lbKG3YPinFoweMRSVTAJhS7AwVZDYpzKtXXTQ.WF3obl2IDtqgvMFRqVdYkD5s",
        "https://cambodiainvestmentreview.com/2026/02/17/cna-documentary-highlights-6-7b-ai-opportunity-by-2030-or-a-widening-digital-divide-for-cambodia-video/"
    ]
};
const philippinesData = {
    ...
    dpiEcosystem: {
        digitalId: {
            title: 'Digital ID',
            status: 'Early Success',
            description: 'PhilSys / PhilID',
            implementationAgency: 'PSA & BSP',
            modalDetails: {
        ...
        payments: {
            title: 'Digital Payments',
            status: 'Early Success',
            description: 'PhilPASSPlus, InstaPay, PESONet',
            implementationAgency: 'PSA & BSP',
            modalDetails: {
        ...
        useCases: [
            {
                sector: 'Social Protection',
                description: '4Ps program (DSWD) — 4.4M+ households served; fully digitised via PhilSys ID verification and PhilPaSSplus payment rails. Note: digital integration with PhilSys and G2P payment rails is planned but not yet confirmed as operational at scale.'
            },
            {
                sector: 'Health',
                description: 'PhilHealth insurance claims integrated with PhilSys registry for real-time eligibility checks and eClaims processing'
            },
            {
                sector: 'Government Finance',
                description: 'LandBank — salaries, pensions, and social benefits processed via eMDS and Link.BizPortal digital rails'
            },
            {
                sector: 'Education',
                description: 'DepEd Learner Information System (LIS) and Project Bukas use digital identifiers to track 1.5M+ teachers and learners'
            },
            {
                sector: 'Cross-DPI Integration',
                description: 'eGovPH Super App — integrates 1,100+ government systems; 440M+ transactions processed as of early 2026'
            }
        ]
    },
    aiEcosystem: {
        policy: {
            title: 'AI Strategy',
            status: 'Early Success',
            description: 'National Artificial Intelligence Strategy',
            implementationAgency: 'DTI',
            modalDetails: {
        ...
        governance: {
            title: 'AI Governance',
            status: 'Open to Adopt',
            description: 'Senate Bill no 25',
            implementationAgency: 'Senate',
            modalDetails: {
        ...
        initiatives: {
            title: 'Government AI Initiatives',
            status: 'Early Success',
            description: 'AI-4RP & SkAI-Pinas',
            implementationAgency: 'DOST',
            modalDetails: {
    ...
    sectionB: {
        ...
        politicalSubParameters: [
            {
                label: 'Elections',
                value: '6-year presidential terms; 3-year midterms (last: May 2025; next presidential: 2028). Transitions are often influenced by political alliance shifts.'
            },
            {
                label: 'Governance Structure',
                value: 'Unitary Republic with significant decentralization to local governments, plus the autonomous BARMM region.'
            },
            {
                label: 'Political Stability',
                value: 'Constitutionally stable but prone to elite factional polarization. Accountability is relatively high, but political stability counts are impacted by internal conflicts.'
            },
            {
                label: 'Digital Priority',
                value: 'Shifting from basic connectivity to heavy digital economy emphasis (AI and cloud-first policies) targeting 12% GDP contribution by 2026.'
            },
            {
                label: 'Institutional Capacity',
                value: 'Uneven. Central agencies demonstrate high technical capacity, whereas rural local government units often lack sufficient budget and technical staff.'
            },
            {
                label: 'Leadership Champions',
                value: 'President Marcos Jr. (championing National ID) and DICT Secretary Henry Rhoel Aguda (driving tech ecosystem orchestration).'
            },
            {
                label: 'Key Influencers',
                value: 'DICT (implementer), NEDA (funding), and Anti-Red Tape Authority (enforcing service automation).'
            },
            {
                label: 'Civil Society',
                value: 'Vibrant and highly active, though facing challenges with disinformation and the complete inclusion of marginalized groups.'
            }
        ],
        leadershipQuote: {
        ...
        actors: [
            {
                id: 'p1',
                type: 'Lead Agency & Govt Coordination',
                name: 'DICT, DTI, DOST, PSA, NPC, BSP',
                role: 'Decision-makers & Implementers',
                initiatives: [
                    'DICT is legally designated lead for DT (RA 10844, RA 12254)',
                    'BSP Circular 1153: regulatory sandbox for fintech/AI',
                    'NPC oversees data protection; PSA manages PhilSys',
                    'Gap: No single lead agency for AI governance as of 2026'
                ]
            },
            {
                id: 'p2',
                type: 'Private Sector',
                name: 'GCash (Mynt), Microsoft, Google Cloud, PLDT/Smart, Aboitiz Data',
                role: 'Implementers & Co-Investors',
                initiatives: [
                    'GCash: 94M users, de facto digital public infrastructure',
                    'Microsoft: MOU with DICT for government Azure cloud',
                    'Google Cloud: first Philippine region activated early 2026',
                    'PLDT VITRO & STT Fairview: AI-ready hyperscale facilities'
                ]
            },
            {
                id: 'p3',
                type: 'Development Partners & MDBs',
                name: 'World Bank, ADB, USAID BEACON, Gates Foundation',
                role: 'Policy Influencers & Funders',
                initiatives: [
                    'World Bank: USD 1.637B digital portfolio (DPLs + PDIP)',
                    'ADB ProSPER: digital tools for Mindanao agriculture',
                    'USAID BEACON: community network deployments',
                    'Gates Foundation: PhilSys + digital financial services grants'
                ]
            },
            {
                id: 'p4',
                type: 'Academic & Research',
                name: 'Ateneo TRL, University of the Philippines, DOST-ASTI COARE',
                role: 'R&D & Talent Development',
                initiatives: [
                    'Ateneo TRL: DPI testing hub for PhilSys integration',
                    'UP Principles for Responsible AI (soft-law guide)',
                    'DepEd-Microsoft E-CAIR: AI literacy scaled to millions',
                    'DOST-ASTI COARE HPC: supercomputing for AI research'
                ]
            },
            {
                id: 'p5',
                type: 'Civil Society',
                name: 'Foundation for Media Alternatives (FMA), Democracy.Net.PH',
                role: 'Advocacy & Oversight',
                initiatives: [
                    'FMA: lead digital rights watchdog monitoring DICT policy',
                    'Democracy.Net.PH: crowdsourced Magna Carta for Philippine Internet Freedom',
                    'Civil society consulted for E-Governance Act (RA 12254) IRR',
                    'Gap: PWDs, indigenous peoples, informal workers excluded from AI/DPI consultations'
                ]
            }
        ]
    },
    sectionD: {
        opportunities: [
            {
                id: 'ph-o1',
                text: 'The Philippines is in the process of operationalising its AI governance architecture, with initiatives such as NAICRI and the national AI roadmap emerging alongside broader digital transformation policies. UNDP can provide technical support on AI governance and regulatory design, drawing on international best practices and supporting the development of responsible AI standards for public-sector deployment.'
            },
            {
                id: 'ph-o2',
                text: 'With large-scale initiatives such as PhilSys (national digital ID), eGovPH, and digital payments infrastructure, the Philippines has built several foundational DPI components. A key opportunity is deepening the use of these foundations for efficient and effective public service delivery — for example, leveraging PhilSys and G2P payment rails for social protection programmes such as 4Ps, pending confirmation that current delivery remains paper-based and digital integration is still in transition. UNDP can support the government in designing interoperability frameworks and prioritising high-impact citizen-facing use cases, ensuring existing infrastructure translates into integrated public services.'
            },
            {
                id: 'ph-o3',
                text: 'The government is investing in AI talent development through initiatives such as Project AGAP.AI and NAICRI, creating momentum for a domestic AI ecosystem. UNDP can support this by linking talent pipelines to real-world public sector use cases and establishing an AI-for-Good accelerator that provides mentorship, grants, and technical support for startups and research teams working on development-focused solutions in sectors such as healthcare, agriculture, and disaster resilience.'
            }
        ],
        risks: [
            {
                id: 'ph-r1',
                text: 'Infrastructure reliability and cybersecurity risks: Despite rapid digital expansion and 5G growth, connectivity gaps persist across rural Visayas and Mindanao. The Philippines remains a major target for ransomware and cyberattacks, with critical digital infrastructure increasingly exposed as government services migrate online.'
            },
            {
                id: 'ph-r2',
                text: 'Vendor dependency and technology lock-in risks: Heavy reliance on foreign hyperscale cloud providers — including AWS and Azure — raises concerns around cyber-resilience, data sovereignty, interoperability, and long-term technology lock-in. The absence of a domestic cloud-first policy creates structural dependency that may constrain future flexibility.'
            },
            {
                id: 'ph-r3',
                text: 'Institutional fragmentation and LGU capacity constraints: Digital transformation mandates exist at the national level, but coordination between DICT, DILG, and Local Government Units remains uneven. The absence of structured capacity building programmes for LGUs — most of which lack dedicated technical staff and digital procurement expertise — is the most binding implementation constraint at the sub-national level. Procurement rules under RA 9184 that prioritise lowest-cost bids and the migration of public-sector IT talent to the private sector further compound this risk.'
            },
            {
                id: 'ph-r4',
                text: 'Digital inclusion risks: Significant disparities in connectivity, device ownership, and digital literacy risk excluding vulnerable populations — particularly in rural Mindanao, the Bangsamoro region, and low-income households — from DPI-enabled services.'
            },
            {
                id: 'ph-r5',
                text: 'Political continuity risks: Active political tensions — including the Marcos-Duterte rift and credible reports of potential election delays — may affect continuity of ICT investments and institutional ownership of the digital transformation agenda across the 2028 election cycle.'
            },
            {
                id: 'ph-r6',
                text: 'Financial sustainability risks: Heavy reliance on external development financing, including World Bank and ADB loans, raises questions about long-term sustainability. High operational costs and limited domestic revenue generation capacity for digital infrastructure create fiscal exposure if external financing contracts.'
            }
        ],
        partnerships: [
            {
    ...
    parameterStages: {
        ...
        P4: {
            ...
            subParameters: [
                ...
                {
                    name: 'Strategic & Long-term Subjective Call',
                    stage: 'Early Success'
                }
            ]
        },
    ...
    sources: [
        "https://erikalegara.com/uploads/NAISR2.0_July2024.pdf",
        "https://senate.gov.ph/legislative-documents/bills/594456",
        "https://www.deped.gov.ph/wp-content/uploads/DO_s2025_013.pdf",
        "https://www.lexology.com/library/detail.aspx?g=91e88551-72ff-439e-82a6-05ace8a7dd61",
        "https://asti.dost.gov.ph/news-articles/asti-pagasa-partner-with-atmo-for-ai-powered-weather-forecasting/",
        "https://atmo.ai/news/philippines-ai-transition",
        "https://asti.dost.gov.ph/projects/itanong/",
        "https://asti.dost.gov.ph/projects/alam-project/",
        "https://pia.gov.ph/news/mmda-eyes-use-of-ai-in-traffic-management/",
        "https://www.pchrd.dost.gov.ph/heartnovation/aina-artificial-intelligence-nutrition-assistant/",
        "https://registry.healthresearch.ph/index.php/registry?cid=8363&layout=details&view=research",
        "https://www.pchrd.dost.gov.ph/news_and_updates/dost-pchrd-presents-ai-driven-innovations-at-amcham-philippines/",
        "https://asti.dost.gov.ph/events/launch-of-the-national-artificial-intelligence-center-for-research-and-innovation/",
        "https://www.ditosapilipinas.com/national/news/article/05/19/2025/dost-asti-inclusive-ai-ecosystem/1599",
        "https://mb.com.ph/2026/02/21/dost-to-launch-national-ai-center",
        "https://pia.gov.ph/news/soccsksargen-backs-dosts-geospatial-technology-ai-initiative/",
        "https://asti.dost.gov.ph/wp-content/uploads/PPAs-2025.pdf",
        "https://dict.gov.ph/news-and-updates/25385",
        "https://pia.gov.ph/news/first-in-asia-world-ph-to-use-blockchain-tech-for-budget/",
        "https://businessmirror.com.ph/2025/07/28/government-to-provide-%E2%82%B11-5-b-for-ai-upskilling-in-2026/",
        "https://news.microsoft.com/source/asia/2026/02/03/deped-and-microsoft-accelerate-learning-recovery-and-ai-literacy-for-filipinos/",
        "https://coare.asti.dost.gov.ph/services",
        "https://asti.dost.gov.ph/news-articles/coare-supercomputing-facility-highlights-its-continuous-support-to-covid-19-centric-initiatives/",
        "https://datacommons.up.edu.ph/about-updc/",
...
"[project]/src/components/dashboard/MacroOverview.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$MockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/MockData.ts [app-client] (ecmascript)");
...
function MacroOverview() {
    _s();
    const [visibleCountries, setVisibleCountries] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        Malaysia: true,
        Cambodia: true,
        Philippines: true,
        Bangladesh: true,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "max-w-6xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-14",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Multi-dimensional assessment of digital readiness parameters."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/MacroOverview.tsx",
                                        lineNumber: 70,
                                        columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: Object.keys(visibleCountries).map((country)=>{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        "aria-label": "Radar chart showing country data",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$component$2f$ResponsiveContainer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveContainer"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$RadarChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RadarChart"], {
                                ...
                                cy: "50%",
                                outerRadius: "80%",
                                data: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$MockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["radarData"],
                                children: [
                                    ...
                                    visibleCountries.Cambodia && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$polar$2f$Radar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Radar"], {
                                        name: "Cambodia",
                                        dataKey: "Cambodia",
                                        stroke: "#059669",
                                        fill: "#059669",
                                    ...
                                    visibleCountries.Philippines && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$polar$2f$Radar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Radar"], {
                                        name: "Philippines",
                                        dataKey: "Philippines",
                                        stroke: "#f59e0b",
                                        fill: "#f59e0b",
                                    ...
                                    visibleCountries.Bangladesh && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$polar$2f$Radar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Radar"], {
                                        name: "Bangladesh",
                                        dataKey: "Bangladesh",
                                        stroke: "#4f46e5",
                                        fill: "#4f46e5",
                                    ...
                                    visibleCountries.Nepal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$polar$2f$Radar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Radar"], {
                                        name: "Nepal",
                                        dataKey: "Nepal",
                                        stroke: "#9333ea",
                                        fill: "#9333ea",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-6 flex flex-col items-center justify-center text-sm text-slate-500 bg-slate-50 p-4 rounded-xl border border-slate-100",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "font-semibold text-slate-700 mb-2",
                                children: "Scoring Scale (1 to 5)"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/MacroOverview.tsx",
                                lineNumber: 193,
                                columnNumber: 21
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mb-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "flex items-center gap-1",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "w-2 h-2 rounded-full bg-slate-300 shadow-sm"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/dashboard/MacroOverview.tsx",
                                                lineNumber: 195,
                                                columnNumber: 67
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs italic mt-1 text-slate-400 text-center",
                                children: "Note: The specific qualitative interpretation of these stages varies for each parameter. See Methodology."
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/MacroOverview.tsx",
                                lineNumber: 201,
                                columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Dive deeper into specific nations to view comprehensive ecosystem assessments, granular infrastructure metrics, primary implementation actors, and contextual strategic insights."
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/MacroOverview.tsx",
                                lineNumber: 254,
                                columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            'nepal'
                                ...
                                href: `/countries/${c}`,
                                className: "inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-slate-800 font-semibold rounded-xl shadow-sm border border-slate-200 hover:border-blue-400 hover:text-blue-600 hover:shadow transition-all group",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1",
                                        "aria-hidden": "true",
                                        children: "→"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/MacroOverview.tsx",
...
_s(MacroOverview, "KLmsvYNO8vCzWVfMoA/jU2Iw80g=");
_c = MacroOverview;
var _c;
__turbopack_context__.k.register(_c, "MacroOverview");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_components_dashboard_536908f8._.js.map